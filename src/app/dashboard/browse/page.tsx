...
export default function DashboardBrowsePage(): React.JSX.Element {
  ...
  return (
    <div className="text-neutral-100 pb-12 space-y-10">
      <div>
        ...
        <p className="text-xs text-neutral-500 mt-2 font-light">
          Explore blueprints, execute spatial vision queries, and engage agents.
        </p>
      </div>
