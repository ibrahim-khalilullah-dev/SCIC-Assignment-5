...
import { Shield, CheckCircle2, AlertOctagon, Loader2 } from "lucide-react";
...
export default function ModeratorInspectionsPage(): React.JSX.Element {
    ...
    <div className="space-y-12 bg-[#040404] min-h-screen text-neutral-100">
      <div className="border-b border-white/[0.02] pb-6">
        ...
        <h1 className="text-3xl font-light uppercase tracking-widest mt-1 flex items-center gap-3">
          <Shield className="w-6 h-6 text-[#dfb780]" /> Moderator Inspections
        </h1>
        <p className="text-xs text-neutral-500 mt-2 font-light">
          Audit and approve spatial portfolio layouts submitted by architects.
        </p>
      </div>
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          className="h-8 bg-emerald-950/20 border border-emerald-500/10 hover:bg-emerald-500/10 text-emerald-400 text-[10px] font-bold uppercase tracking-wider rounded-lg flex items-center gap-1.5 cursor-pointer"
                        >
